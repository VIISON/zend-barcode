...
namespace Zend\Barcode\BarcodeObject;
 ...
 */
abstract class AbstractBarcodeObject implements BarcodeObjectInterface
{
    /**
     ...
     * @var string
     */
    protected $barcodeNamespace = 'Zend\Barcode\BarcodeObject';
     ...
     *
     * @param  array $options
     * @return \Zend\Barcode\BarcodeObject\BarcodeObjectInterface
     */
     ...
     * @param int $value
     * @return \Zend\Barcode\BarcodeObject\BarcodeObjectInterface
     * @throws \Zend\Barcode\BarcodeObject\Exception\ExceptionInterface
     */
